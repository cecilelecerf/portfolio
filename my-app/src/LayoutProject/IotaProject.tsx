...
export const IotaProject: Project['layout'] = {
  ...
  me: (
    <Text>
      ...
      Développement front-end des activités avec attention particulière aux
      animations interactives pour rendre la plateforme ludique et immersive
      <br></br>
      Conception pédagogique des activités basée sur les 5 domaines de
      compétences du CRCN
    </Text>
  ),
  infos: {
