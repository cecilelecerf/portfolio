...
export const SingleProject = ({ project }: { project: Project }) => {
    ...
    return (
        <Stack gap="xl">
            <BackgroundImage src={project.pictures?.[0].src ?? defaultBg.src} mb="xl" className={filter.filter} p="lg">
            ...
            {project.layout.more && (
                ...
                <Box>
                    <Title order={2} mb="md">Quelque info supplémentaire</Title>
                    {project.layout.more}
                </Box>
            )}
        </Stack>
