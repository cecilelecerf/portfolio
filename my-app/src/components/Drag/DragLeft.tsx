...
export const DragLeft = ({ isOpen, setOpen }: { isOpen: boolean, setOpen: Dispatch<SetStateAction<"left" | "right" | null>> }) => {
    ...
    return (
        ...
        >
            ...
            <Text onClick={() => setOpen((is) => is === "left" ? null : "left")} fs="italic" c="gray.6">{isOpen ? "Glisser pour fermer" : "Glisser pour ouvrir"}</Text>
        </Stack>
    );
};
